...
public class GeneratorServiceEntity {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        gc.setOutputDir("F:\\github\\cn.liuyiyou.shop\\shop-prod\\src\\main\\java");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/shop-prod");
        ...
        strategy.setInclude(new String[]{"home_page_prod"}); // 需要生成的表
        //strategy.setExclude(new String[]{"test"}); // 排除生成的表
        mpg.setStrategy(strategy);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("cn.liuyiyou.shop.prod");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return "F:\\github\\cn.liuyiyou.shop\\shop-prod\\src\\main\\resources" + "/mappers/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
